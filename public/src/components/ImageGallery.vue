...
#image-gallery-root {
  ...
  align-items: center;
  grid-template-areas: 'left-arrow main right-arrow';
}
...
export default class ImageGallery extends Vue {
  ...
  private get image() {
    ...
    return {
      ...
      alt:
        path === 'cbd-flower'
          ? '28 grams of CBD Hemp Flower'
          : path === 'unfiltered-cbd-joints'
          ? 'Unfiltered, Prerolled CBD Hemp Joints'
          : 'Prerolled Filtered Hemp CBD Cigarettes'
    };
  }
}
</script>